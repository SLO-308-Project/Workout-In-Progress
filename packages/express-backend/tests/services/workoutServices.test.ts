...
describe("Workout Services Tests", () =>
{
    ...
    test("Get workout --- failure (session not found)", async () =>
    {
        sessionModel.findById = jest.fn().mockRejectedValue(null);
        try
        {
    ...
    {
        sessionModel.findOne = jest.fn().mockRejectedValue(null);
        try
        {
            const sessionId = "6458a28d1f3d7c9a8e1b2c46";
            const workoutId = "6458a28d1f3d7c9a8e1b2c46";
