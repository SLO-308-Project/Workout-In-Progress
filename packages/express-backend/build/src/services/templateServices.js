...
function addTemplate(template) {
    ...
    const templateToAdd = new sessionTemplate_1.default(template);
...
function getTemplateById(id) {
    return sessionTemplate_1.default.findById(id);
}
/**
...
function getTemplates() {
    return sessionTemplate_1.default.find();
}
/**
...
function deleteTemplate(id) {
    return sessionTemplate_1.default.findByIdAndDelete(id);
}
exports.default = {
    addTemplate,
    deleteTemplate,
