...
}: Props)
{
    return (
        <View>
            <View className="">
                <Text className="px-4 pt-3 rounded-xl text-base font-bold text-black">
                    {name}
                </Text>
                <Text className="px-8 pt-1 text-base">Date:{" " + date}</Text>
                <Text className="px-8 py-1 text-base">
                    Time:{" " + duration}
                </Text>
            </View>
            {/* Render each Workout */}
            <View className="bg-gray-100 border border-gray-400 rounded-lg shadow-sm p-2 m-1 justify-center">
                <Text className="text-base">Machines:</Text>
                <FlatList
